                    ...
                    {availableUsers.length === 0 ? (
                      ...
                      availableUsers.map((availableUser) => (
                        <div
                          ...
                          className="p-3 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors border border-gray-200"
                        >
                  ...
                  <>
                    {loading ? (
                      ...
                      <div className="text-center text-gray-500 space-y-3">
                        <div className="text-sm">No hay conversaciones activas</div>
                        <button
                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-2 max-h-[60vh] min-h-[200px]" style={{scrollBehavior: 'smooth'}}>
                  {messages.length === 0 ? (
                    <div className="text-center text-gray-500 text-sm space-y-2">
                      <div className="text-lg font-medium">¡Inicia la conversación!</div>
