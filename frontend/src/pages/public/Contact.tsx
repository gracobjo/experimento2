  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${(import.meta as any).env.VITE_API_URL}/api/contact`, {
        ...
        body: JSON.stringify({
          ...formData,
          ip: 'unknown', // En producción se obtendría del servidor
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Estamos aquí para ayudarte. Nuestros abogados especialistas están listos para 
              atender tu consulta y brindarte la asesoría legal que necesitas.
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="contratos">Elaboración de Contratos</option>
                      <option value="herencias">Gestión de Herencias</option>
