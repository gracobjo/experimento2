...
const ChatPage = () => {
  ...
  useEffect(() => {
    ...
    const token = localStorage.getItem('token');
            const newSocket = io(`${(import.meta as any).env.VITE_API_URL || 'https://experimento2-production-54c0.up.railway.app'}`, {
      auth: {
        token,
        user: {
          id: user.id,
  ...
  const handleStartNewConversation = (lawyerId: string) => {
    setSelectedLawyer(lawyerId);
    setSelectedConversation(lawyerId);
    setMessages([]);
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-4 border-b">
            <h1 className="text-xl font-semibold">Chat con Abogado</h1>
            <p className="text-sm text-gray-600">Comunicación directa con tu abogado</p>
          </div>
            ...
            <div className="w-1/3 border-r bg-gray-50">
              ...
              <div className="p-4 border-t">
                ...
                <select
                  ...
                  aria-label="Seleccionar abogado para nueva conversación"
                >
              ...
              {selectedConversation ? (
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-sm">O inicia una nueva conversación con un abogado</p>
                  </div>
                </div>
              )}
            </div>
