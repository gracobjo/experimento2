...
async function testFinalInvoice() {
  try {
    console.log('🧪 Iniciando prueba final de factura optimizada...');
    
    // Datos de prueba simples
    const testInvoiceData = {
      numeroFactura: "FINAL-2025-001",
      tipoFactura: "F",
    ...
    console.log('📋 Datos de prueba finales');
    ...
    // Crear la factura
    console.log('🔄 Creando factura final...');
    ...
    const expectedSizeRange = {
      min: 20000,  // Mínimo para una página A4 ultra-optimizada
      max: 100000  // Máximo para una página A4 ultra-optimizada
    };
    ...
    fs.writeFileSync('test-final-invoice.pdf', pdfResponse.data);
    console.log('📁 PDF guardado como: test-final-invoice.pdf');
    ...
    console.log('📁 Archivo generado: test-final-invoice.pdf');
