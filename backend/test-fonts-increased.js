...
async function testFontsIncreased() {
  try {
    console.log('🧪 Iniciando prueba con fuentes incrementadas...');
    
    // Datos de prueba con fuentes más grandes
    const testInvoiceData = {
      numeroFactura: "FONTS-001",
      tipoFactura: "F",
      ...
      items: [
        {
          description: "Asesoramiento legal completo",
          quantity: 2,
          unitPrice: 7500,
          total: 15000
        },
    ...
    console.log('📋 Datos de prueba con fuentes incrementadas');
    ...
    // Crear la factura
    console.log('🔄 Creando factura con fuentes incrementadas...');
    ...
    // Descargar el PDF
    console.log('📥 Descargando PDF con fuentes incrementadas...');
    ...
    const expectedSizeRange = {
      min: 20000,  // Mínimo para una página A4 con fuentes más grandes
      max: 120000  // Máximo para una página A4 con fuentes más grandes
    };
    ...
    fs.writeFileSync('test-fonts-increased.pdf', pdfResponse.data);
    console.log('📁 PDF guardado como: test-fonts-increased.pdf');
    ...
    console.log('🎯 Prueba con fuentes incrementadas completada');
    console.log('📁 Archivo generado: test-fonts-increased.pdf');
    console.log('📏 Tamaño final:', pdfBuffer.length, 'bytes');

  } catch (error) {
    console.error('❌ Error en la prueba con fuentes incrementadas:', error.message);
    if (error.response) {
...
// Ejecutar la prueba con fuentes incrementadas
testFontsIncreased(); 