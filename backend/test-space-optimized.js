...
async function testSpaceOptimized() {
  try {
    console.log('🧪 Iniciando prueba con espacio optimizado...');
    
    // Datos de prueba con espacio optimizado
    const testInvoiceData = {
      numeroFactura: "SPACE-001",
      tipoFactura: "F",
    ...
    console.log('📋 Datos de prueba con espacio optimizado');
    ...
    // Crear la factura
    console.log('🔄 Creando factura con espacio optimizado...');
    ...
    // Descargar el PDF
    console.log('📥 Descargando PDF con espacio optimizado...');
    ...
    fs.writeFileSync('test-space-optimized.pdf', pdfResponse.data);
    console.log('📁 PDF guardado como: test-space-optimized.pdf');
    ...
    console.log('🎯 Prueba con espacio optimizado completada');
    console.log('📁 Archivo generado: test-space-optimized.pdf');
    console.log('📏 Tamaño final:', pdfBuffer.length, 'bytes');

  } catch (error) {
    console.error('❌ Error en la prueba con espacio optimizado:', error.message);
    if (error.response) {
...
// Ejecutar la prueba con espacio optimizado
testSpaceOptimized(); 