...
def get_backend_info():
    ...
    try:
        ...
        contact_response = requests.get(f"{BACKEND_URL}/parametros/contact", timeout=5)
...
def get_services_info():
    ...
    try:
        ...
        cases_response = requests.get(f"{BACKEND_URL}/cases", timeout=5)
...
def get_honorarios_info():
    ...
    try:
        ...
        invoices_response = requests.get(f"{BACKEND_URL}/invoices", timeout=5)
...
def handle_appointment_conversation(user_id: str, message: str) -> str:
    ...
    # Confirmación
        ...
        if is_affirmative_response(message):
            ...
            try:
                response = requests.post(f"{BACKEND_URL}/appointments/visitor", json=conv.data, timeout=10)
